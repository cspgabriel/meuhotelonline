...
for(const name of ['index.html','assets','mkt','demo','orcamento'])fs.cpSync(path.join(root,name),path.join(out,name),{recursive:true});
...
console.log('Build estatico: home + assets + mkt + demo + orcamento. Documentacao operacional excluida.');
